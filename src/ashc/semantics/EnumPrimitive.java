...
public enum EnumPrimitive {
    ...
    private EnumPrimitive(final String ashName, final String javaName,
	    final boolean isNumeric, final boolean wholeNumber) {
	...
	return isPrimitive(indexType.shortName) && (indexType.arrDims == 0)
		&& getPrimitive(indexType.shortName).validForArrayIndex;
    }
