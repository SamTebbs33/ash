...
public class OperatorDef {
	...
	addOperatorDef(new OperatorDefNative(EnumOperation.POW, "**", "pow", EnumOperatorType.BINARY, 100, EnumOperatorAssociativity.LEFT, new NativeOpInfo(-1, EnumInstructionOperand.DOUBLE)));
