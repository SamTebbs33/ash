...
def do_test(name, path, run):
	...
	status = subprocess.call(["java", "-cp", "../build:../lib/asm-5.0.4.jar:../lib/asm-tree-5.0.4.jar:../lib/asm-analysis-5.0.4.jar:../lib/asm-commons-5.0.4.jar:../lib/asm-util-5.0.4.jar", "ashc/main/AshMain", path+".ash", "-o", "../classes"])
	if run and status == 0:
